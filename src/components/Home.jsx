...
const Home = () => {
  ...
  <h1 className='text-2xl md:text-3xl'>Hi There,<span >👋</span></h1>
    <h2 className='text-4xl sm:text:4xl font-bold'>I am a Fulll Stack Developer</h2>
    <p  className='text-gray-400'>
      I am very experienced in building and designing
      software.
      currently,I work mostly on Web Applicartions Using
      Technologies like  React js,Python,Tailwind. 
      Also in mobile app devepment using 
      react native.
    </p>
